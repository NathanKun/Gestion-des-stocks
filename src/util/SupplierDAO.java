...
public class SupplierDAO {
	 ...
	 * @param supplier contain the new supplier o add
	...
	public List<Supplier> getSupplierList(){
		...
		try{
			...
			while(rs.next())
				retour.add(new Supplier(rs.getLong("spr_id"),
	 ...
	 * @param id identifiant of the supplier
	 * @return the supplier
	 */
	 ...
	 * @param id contain the id of the supplier we want to delete
