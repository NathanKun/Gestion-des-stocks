...
public class userDAO {
	...
	public userDAO() {
		...
		try {
			...
			System.err.println("impossible to load the BDD pilot, please make sure you have import the .jar folder in the project");
		}
	}
	 ...
	 * @param id identifiant whish we give to have his user owner
	...
	public List<User> getUserList(){
		...
		try{
			...
			while(rs.next())
				retour.add(new User(rs.getString("usr_id"),
						rs.getString("usr_pw"),
	 ...
	 * @param id contain the id of the user we want to delete
