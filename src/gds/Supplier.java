...
public class Supplier implements Comparable<Supplier> {
	...
	private String name;
	/**
	 * contain the list of product of the supplier. Long: id of the product
	 ...
	 * 
	 * @param name
	 *            contain the new name of the supplier
	 */
	...
	/**
	 * return the table of the supplier's product with the price.
	 * 
	 ...
	 *            id of the product
	 * @param price
	 *            contain the price of the product
	 */
	 ...
	 * 
	 * @param product
	 *            contain the product which we want to remove of the list
	 */
	 ...
	 * 
	 * @param productId
	 *            id of the product which we set the price
	 * @param price
	 ...
	 */
	@Override
	public int compareTo(Supplier spr) {
		return name.compareTo(spr.getName());
	}
}
